...
#include "config_overrides.h"
  ...
  CONFIG_ADD_VAR(DEMES_PARASITE_MIGRATION_RATE, double, 0.0, "Probability of a parasite migrating to a different deme"); // MIGRATION_MATRIX
  ...
  CONFIG_ADD_VAR(NEURON_MAX_DIST, int, 0, "Maximum distance input avatars can move from the output avatar (manhattan distance).");
